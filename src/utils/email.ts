...
export async function sendAppointmentEmail(appointment: AppointmentEmailInput) {
  ...
  // fine for testing. Once you verify your own domain in the Resend
  // dashboard, set FROM_EMAIL (e.g. "Parampara Divya Ayurved <appointments@paramparadivyaayurved.com.np>")
  ...
  try {
    ...
    if (error) {
      console.error("sendAppointmentEmail: Resend returned an error:", error);
    }
  } catch (err) {
...
const BRAND_DARK = "#553db5"; // primary (buttons, header, accents)
const BRAND_LIGHT = "#dceefa"; // soft tint (backgrounds, borders)
            ...
            <tr>
              <td style="background-color: ${BRAND_DARK}; padding: 30px 32px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      <span style="font-family: Helvetica, Arial, sans-serif; font-size: 19px; font-weight: 700; color: #ffffff;">Om Kapan Dental</span>
                    </td>
                    <td align="right">
