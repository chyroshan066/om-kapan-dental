...
//             </div>
//             {/* Contact us form */}
//             <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-7 mt-10 xl:mt-16">
//               {/* name input */}
...
//                 <input className="form-input" id="phone" name="phone" type="tel" placeholder="Enter your phone number..." required />
...
//                 <textarea className="form-input min-h-[234px] max-h-[234px] lg:min-h-[116px] lg:max-h-[116px] xl:min-h-[234px] xl:max-h-[234px]" id="message" name="message" placeholder="Enter your messages..." required></textarea>
...
//               {/* Submission feedback */}
//               {status === "success" && (
//                 <p className="sm:col-span-2 text-sm font-medium text-emerald-600" role="status">
//                   Thanks! Your appointment request has been received — we&apos;ll be in touch shortly.
//                 </p>
//               )}
//               {status === "error" && errorMessage && (
//                 <p className="sm:col-span-2 text-sm font-medium text-red-500" role="alert">
//                   {errorMessage}
//                 </p>
//               )}
...
//                   className="h-12 w-full sm:w-44 bg-primary text-white text-sm font-bold text-center leading-[3rem] rounded-xl transition-colors hover:bg-indigo-800 disabled:opacity-60"
//                 >
