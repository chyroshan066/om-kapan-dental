...
//                         </div>
//                         {/* Right Side */}
//                         <p className="text-center lg:text-start lg:max-w-sm text-[15px] font-medium text-slate-800/70 -mb-8">Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts</p>
//                     </div>
//                     {/* User TESTIMONIAL */}
