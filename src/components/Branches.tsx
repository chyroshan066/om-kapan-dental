...
//                         <div
//                             key={index}
//                             className="flex flex-col gap-y-6 bg-white border border-gray-100 rounded-3xl p-8 shadow-sm transition-all hover:shadow-2xl hover:shadow-slate-400/20 hover:-translate-y-1"
//                         >
//                             {/* Branch name + tag */}
...
//                                         src="/images/icons/location-icon.webp"
//                                         alt="location-icon"
//                                     />
//                                     {branch.address}
//                                 </p>
...
//                                     <img
//                                         className="w-5 h-5 shrink-0"
//                                         src="/images/icons/clock-icon.webp"
//                                         alt="clock-icon"
//                                     />
//                                     {branch.hours}
//                                 </p>
